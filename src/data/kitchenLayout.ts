...
export const kitchenLayout: Area[] = [
  { 
    ...
    units: [
      ...
      { id: "FREEZER", label: "Upright Freezer", zones: ["FreezerShelf1", "FreezerShelf2", "FreezerShelf3", "FreezerShelf4", "FreezerBottomBin"] },
      // Tall pantry: 8 shelf zones
      { id: "PANTRY", label: "Tall Pantry", zones: ["PantryShelf1", "PantryShelf2", "PantryShelf3", "PantryShelf4", "PantryShelf5", "PantryShelf6", "PantryShelf7", "PantryShelf8"] },
      // Main fridge with interior zones, left door bins, right door bins
      { id: "FRIDGE", label: "Main Fridge", zones: [
        "FridgeTopShelfLeft", "FridgeTopShelfRight", "FridgeMiddleShelf", "FridgeBottomShelf",
        "CrisperLeft", "CrisperRight",
        "FridgeLeftDoorTop", "FridgeLeftDoorMiddle", "FridgeLeftDoorBottom",
        "FridgeRightDoorTop", "FridgeRightDoorMiddle", "FridgeRightDoorBottom"
      ]},
